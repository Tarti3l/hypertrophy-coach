...
| [4] Sustituir los consumos ficticios por los registros reales | en curso | | Tomado por Codex en worktree `item-4-Codex` (branch `item-4-consumos-reales`). Sale del hallazgo incidental del [2]: el dashboard de Alimentación está hardcodeado |
